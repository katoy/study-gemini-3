...
if __name__ == "__main__":
    ...
    chapters = [
        ["00_前付け", 1, 3],
        ["01_まえがき", 4, 17],
        ["02_第1章_Agent_Skillsって何だろう", 18, 48],
        ["03_第2章_オープンスタンダードの中身", 49, 68],
        ["04_第3章_はじめてのスキル体験", 69, 102],
        ["05_第4章_デザイン系スキル", 103, 131],
        ["06_第5章_ドキュメント・スプレッドシート系スキル", 132, 152],
        ["07_第6章_開発・コラボレーション系スキル", 153, 185],
        ["08_第7章_パートナースキル・サードパーティスキル", 186, 226],
        ["09_第8章_skill-creatorによるスキル作成の基本", 227, 262],
        ["10_第9章_配布・セキュリティ・組み込みスキル", 263, 290],
        ["11_付録_Appendix", 291, 297],
        ["12_索引_Index", 298, 308]
    ]

    input_pdf = "./Kindle_14.pdf"
    output_directory = "./output/Kindle_14/chapters"
