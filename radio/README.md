...
- **製品寄りの操作導線**: ヘルプダイアログ、キーボードショートカット、保存済みエピソード行の `☑` マークで以下の機能をサポートしています。
  - **左クリック**: デフォルトプレイヤーで再生
  - **右クリック**: コンテキストメニュー（再生、フォルダを開く、パスをコピー、ファイル名をコピー、ファイルを削除、再度ダウンロード、番組ページを開く）
- **ダウンロード時の上書き確認**: 既に保存済みのエピソードをダウンロード選択した場合、確認ダイアログを表示します。
